---
name: WhyGraph Pre-Edit Brief
description: Before editing, refactoring, renaming, deleting, or replacing existing code, call the whygraph_rationale_brief MCP tool to learn the intent, constraints, tradeoffs, and risks behind it. Skip for new code, typos, or formatter-only changes.
---
