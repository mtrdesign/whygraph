...
Revision ID: 4bde3eda78f2
Revises:
Create Date: 2026-05-25 17:38:39.113102
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "commit_count", sa.Integer(), server_default=sa.text("0"), nullable=False
        ),
        sa.Column(
            "pr_count", sa.Integer(), server_default=sa.text("0"), nullable=False
        ),
        sa.Column(
            "issue_count", sa.Integer(), server_default=sa.text("0"), nullable=False
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    with op.batch_alter_table("author", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_author_primary_email"), ["primary_email"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_author_primary_login"), ["primary_login"], unique=False
        )
    ...
    with op.batch_alter_table("commit", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_commit_authored_at"), ["authored_at"], unique=False
        )
    ...
    with op.batch_alter_table("pr_issue_link", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_pr_issue_link_issue_number"), ["issue_number"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column("fetched_at", sa.Text(), nullable=False),
        sa.Column(
            "commit_titles", sa.Text(), server_default=sa.text("'[]'"), nullable=False
        ),
        sa.Column(
    ...
    with op.batch_alter_table("pull_request", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_pull_request_merge_commit_sha"),
            ["merge_commit_sha"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_pull_request_state"), ["state"], unique=False
        )
